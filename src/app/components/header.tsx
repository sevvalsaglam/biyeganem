    ...
    <header className="fixed top-0 left-0 right-0 z-50 bg-[#f0efe6]/80 backdrop-blur-sm">
      <div className="container mx-auto px-4 py-4 flex items-center justify-between">
        ...
        <nav className="hidden md:flex items-center space-x-4">
          ...
          {/* Static Pages */}
          <Link href="/hakkimizda" className="px-4 py-2 text-sm font-medium hover:bg-black hover:text-white rounded-full">
            Hakkımızda
          </Link>
          <Link href="/trendler" className="px-4 py-2 text-sm font-medium hover:bg-black hover:text-white rounded-full">
            Trendler
          </Link>
          <Link href="/galeri" className="px-4 py-2 text-sm font-medium hover:bg-black hover:text-white rounded-full">
            Galeri
          </Link>
          <Link href="/iletisim" className="px-4 py-2 text-sm font-medium hover:bg-black hover:text-white rounded-full">
            İletişim
          </Link>
        </nav>
